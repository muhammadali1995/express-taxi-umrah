...
export default function Pricing() {
  return (
    <>
      <div className="relative md:min-h-screen bg-[rgba(0,0,0,0.9)] lg:bg-white">
          ...
          <div className="relative z-10 pt-14 lg:w-full lg:max-w-2xl lg:min-h-screen">
            ...
            <div className="relative mx-auto lg:mx-0 px-6 py-20 sm:py-32 lg:px-0">
              <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                <h1 className="uppercase text-4xl font-bold tracking-tight lg:text-gray-900 sm:text-6xl">
                  Narxlar
                </h1>
                <p className="mt-6 text-lg leading-8 text-white lg:text-gray-600">
                  Express Taksi Xizmati | Eng Yaxshi Haj/Umra Taksi Xizmati{" "}
                  {">"} NARXLAR
                </p>
        ...
        <div className="bg-gray-50  opacity-80 blur-xs lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <Image
      ...
      <div className="mx-w-7xl mx-auto my-10">
        <h1 className="text-3xl lg:text-[44px] text-center mb-2">
          Narxlarni Xisoblang
        </h1>
